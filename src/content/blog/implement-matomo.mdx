...
*AMRIT's open-source ecosystem a **nationwide digital health platform** with multiple UIs and APIs powering healthcare delivery across India.*
...
So, we built a **multi-layered architecture** that kept everything behind **secure boundaries**:
