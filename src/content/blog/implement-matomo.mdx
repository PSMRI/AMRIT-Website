...
subtitle: "Building Privacy-First Analytics with Matomo in C4GT 2025"
...
We needed an analytics solution that **didn’t rely on any third-party services** and could be **fully self-hosted** within AMRIT’s infrastructure — which made Matomo the ideal choice.
...
This ensures that no sensitive information is exposed publicly, maintaining full control over user analytics within AMRIT’s infrastructure.
...
#### 🔹 The Client Architecture: One Service to Track Them All
...
Seeing the **first real-time event** appear on the dashboard felt **magical** ✨
