...
We were able to find a call spanning multiple services that took too long to complete - something that would have gone unnoticed if we saw it in isolation.
